            ...
            <div className="p-7">
              <form>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="fullName"
                        id="fullName"
                        placeholder="Jamshidddd"
                        defaultValue="Jamshidddd"
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="+998997699900"
                        defaultValue="+998997699900"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button className="flex justify-center rounded-[7px] bg-primary px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90">
                    Save
                  </button>
                </div>
              </form>
